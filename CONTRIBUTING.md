# Contributing to jest-json-schema
...
1. Fork the repository `jest-json-schema` to your GitHub account.
2. Afterwards run the following commands in your terminal

    ```bash
    $ git clone https://github.com/<your-github-username>/jest-json-schema
    $ cd jest-json-schema
    ```
